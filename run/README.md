...
| `aicoop_config` / `aicoop_config.exe` | Linux / Windows | SDL3 editor for AI behaviour: the **co-op companion** (`-aicoop`) thresholds/ranges (`coop_*`) **and** the **monster pack-hunt AI** (`monster_*`). Writes to `aidoom.cfg`. |
