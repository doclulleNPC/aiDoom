#!/usr/bin/env python3
"""
bake_buddy_face.py -- pack the AI co-op buddy's mugshot graphics into buddy.wad.
...
W_CacheLumpName resolves them straight out of buddy.wad.

Source: run/buddyface/BUF*.lmp (already in Doom patch_t format -- raw lumps, copied
verbatim).  This script merges them into the existing run/buddy.wad (which also holds
...
Usage:
    ...
    python3 tools/bake_buddy_face.py --wad run/buddy.wad --faces run/buddyface
"""
